    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clients.update", [$client->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clietn_name') ? 'is-invalid' : '' }}" type="text" name="clietn_name" id="clietn_name" value="{{ old('clietn_name', $client->clietn_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cleint_number') ? 'is-invalid' : '' }}" type="number" name="cleint_number" id="cleint_number" value="{{ old('cleint_number', $client->cleint_number) }}" step="1">
